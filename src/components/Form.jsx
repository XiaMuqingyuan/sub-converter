      ...
      <form {...{'x-on:submit.prevent': 'submitForm'}} class="space-y-8">
        ...
        <div class="rounded-2xl border border-black/10 bg-white/70 p-6 shadow-soft dark:border-white/10 dark:bg-white/[0.04] md:p-8">
          <TextareaWithActions
            ...
            label={t('shareUrls')}
            labelPrefix={
              <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-50 text-primary-600 dark:bg-primary-900/20 dark:text-primary-400">
        ...
        <div x-show="showAdvanced" {...COLLAPSE_ATTRS} class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {UNIFIED_RULES.map((rule) => (
                ...
                >
                  ...
                  />
                  <span class="ml-3 text-sm font-medium text-gray-700 transition-colors group-hover:text-gray-900 dark:text-gray-300 dark:group-hover:text-white">
          ...
          <SectionCard icon="fa-file-export" title={t('subconverterConfigTitle')}>
            ...
            <div class="mt-3 flex justify-end">
              ...
              >
                ...
                <span x-text={`subconverterCopied ? '${t('copiedSubconverterUrl')}' : '${t('copySubconverterUrl')}'`} />
              </button>
            </div>
          </SectionCard>
            ...
            <ValidatedTextarea
              ...
              validation={{
                button: {
                  ...
                  className: 'flex items-center gap-2 rounded-lg bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-200 dark:bg-[#3b3b3b] dark:text-gray-300 dark:hover:bg-white/10',
                  attrs: { 'x-on:click': 'validateBaseConfig()' }
                },
                success: {
          ...
          {/* User Agent */}
          <SectionCard icon="fa-user-secret" title={t('UASettings')}>
            <input
              type="text"
              x-model="customUA"
              class="w-full rounded-lg border border-black/10 bg-gray-50 px-4 py-2 text-gray-900 outline-none focus:border-primary-400 dark:border-white/10 dark:bg-[#3b3b3b] dark:text-white"
            ...
            {LINK_FIELDS.map((field) => (
              <div class="relative group" key={field.key}>
                ...
                <div class="flex gap-2">
                  ...
                  >
                    <i class="fas" x-bind:class={`copied === '${field.key}' ? 'fa-check' : 'fa-copy'`} />
                  </button>
                </div>
              </div>
            ))}
          ...
          <div class="mt-6">
            ...
            <div class="mt-4 flex justify-center">
              ...
              >
                ...
                />
                <span x-text="shortenedLinks ? showFullLinksText : (shortening ? shorteningText : shortenLinksText)" />
              </button>
            </div>
          </div>
        </div>
